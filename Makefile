...
SIMAPP = ./app
HTTPS_GIT := https://github.com/Canto-Network/ethermint.git
...
docker-build:
	...
	docker create --name ethermint -t -i Canto-Network/ethermint:latest ethermint
...
PACKAGE_NAME:=github.com/Canto-Network/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/Canto-Network/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/Canto-Network/ethermint/tests/importer
