...
1. Either [open](https://github.com/Canto-Network/ethermint/issues/new/choose) or
   [find](https://github.com/Canto-Network/ethermint/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/Canto-Network/ethermint/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
When proposing an architecture decision for Ethermint, please start by opening an [issue](https://github.com/Canto-Network/ethermint/issues/new/choose) or a [discussion](https://github.com/Canto-Network/ethermint/discussions/new) with a summary of the proposal. Once the proposal has been discussed and there is rough alignment on a high-level approach to the design, the [ADR creation process](https://github.com/Canto-Network/ethermint/blob/main/docs/architecture/PROCESS.md) can begin. We are following this process to ensure all involved parties are in agreement before any party begins coding the proposed implementation. If you would like to see examples of how these are written, please refer to the current [ADRs](https://github.com/Canto-Network/ethermint/tree/main/docs/architecture).
...
`$GOPATH/src/github.com/Canto-Network/ethermint`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on GitHub, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/Canto-Network/ethermint`)
...
- create a development branch either on github.com/Canto-Network/ethermint, or your fork (using `git remote add origin`)
...
- Architecture Decision Records (ADRs) may be proposed by any contributors or maintainers of Ethermint,
    ...
    [ADR Creation Process](https://github.com/Canto-Network/ethermint/blob/main/docs/architecture/PROCESS.md)
