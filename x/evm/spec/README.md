...
The `x/evm` is part of the [ethermint library](https://pkg.go.dev/github.com/Canto-Network/ethermint). For an example of how Ethermint can be used on any Cosmos-SDK chain, please refer to [Evmos](https://www.github.com/tharsis/evmos).
